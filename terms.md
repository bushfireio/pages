...
1. By making the relevant clickwrap consent or checking / ticking the relevant box at the end of this Agreement (or as otherwise set out by Disaster Science), the User agrees and acknowledges that the User:
...
1. (Definitions): In this Agreement, unless the context otherwise requires:
    ...
    **API** means the Application Programming Interface for the services as defined by Disaster Science and which may be made available by Disaster Science to the User.

    **Privacy Policy** means the privacy policy of Disaster Science as accessible on https://bushfire.io/ and as amended from time to time.

    **Commencement Date** means the date on which Disaster Science provides the User with access to the Services.
    ...
    **User** means any user of the Platform or Services, including any individual, body corporate, or bot operator.
    ...
    **Platform** means any component necessary to receive the Services, including, but not limited to a website, token, applications, API, or other data platform.

    **Privacy Act** or **Privacy Law** means the Privacy Act 1988 (Cth) and its amendments from time to time.

    **Product** means the Services offered.

    **Services** means the Services as set out in Schedule 1 to this Agreement.

    **Services Fee** means, in respect of the Services, the fee set by the Disaster Science.

    **Term** means the term of this Agreement as determined pursuant to clause 26.

    **Terms and Conditions** means this Agreement.

    **Third Parties** means applications, software, platforms and services provided or operated by third parties, including features, aspects and information made available or provided by such third parties.

    **Underlying Systems** means the IT solutions, systems, networks (including software and hardware), User Interface and API used to provide the Services, including any third-party solutions, systems and networks.

    **User Interface** means the user interface by which the User uses the Services as varied by Disaster Science from time to time.
...
6. (Default Use of Services): The User, must:
    ...
    1. use the Services exclusively for its personal purposes limited to viewing data on natural disasters and emergency incidents for and relation to only the User;
    ...
    4. comply with any terms, inclusive of privacy and general use terms, on the Platform, as updated from time to time by Disaster Science.

7. (Access conditions): When accessing the Services, the User must not:
    ...
    4. that which the User is authorised to access; and
    5. to the extent necessary for the User to use the Services in accordance with this Agreement;
    6. use the Services to undertake or assist with provision of data provided by the Disaster Science to any third parties or in relation to any third parties;
    7. commercially exploit the Services (including by making it available to a third party); and
...
8. (Acceptable Use): The User agrees to take reasonable steps not to use the Services in a way that is unacceptable. Use is unacceptable if:
...
10. (Expenses): The User agrees to reimburse the Disaster Science for all properly incurred Expenses.

11. (Adjustment): The Services Fee may be reviewed by the Disaster Science at any time and adjusted by written 60 days written notice to the User.

12. (Invoicing): Unless otherwise agreed, the Disaster Science must issue an appropriate invoice for the Services Fee associated with the Services to be performed during an upcoming calendar month. No amount will be payable under this Agreement unless it is included in the balance of a properly issued invoice, unless the terms of payment are as otherwise agreed in advance.

13. (Payment Terms): Unless otherwise agreed, the User must make full payment of any invoice issued pursuant to clause 18 before receiving any Services.

14. (Interest): Unless otherwise agreed, if the User fails to make full payment of an invoice by the due date for payment specified on that invoice, interest shall accrue on the unpaid amount at the Interest Rate, compounding daily on the basis of a 365 day year.
...
18. (Disaster Science’s access to Data): The User acknowledges that:

    1. Disaster Science may require access to the User Data to exercise its rights and perform its obligations under this Agreement; and
    2. to the extent necessary, Disaster Science may authorise a member or members of its personnel to access the User Data for any purpose in relation to the Services.

19. (Analytical Data): The User acknowledges and agrees that, Disaster Science may:
    1. use User Data to generate anonymised and aggregated statistical and analytical data (Analytical Data); and
    2. use Analytical Data for Disaster Science’s internal research and product development purposes and to conduct statistical analysis and identify tends and insights; and
    3. supply Analytical Data to third parties, and Disaster Science’s rights under clause 18 survive termination of this Agreement; and
    4. title to, and all Intellectual Property Rights in, Analytical Data is and remains the property of Disaster Science.

20. (No On-selling or Marketing of Data): Disaster Science may not use the User Data or Analytical Data for marketing or on-selling purposes. Any use of User Data and Analytical Data is exclusively limited to Services and product improvement.

21. (Personal Information): The User consents to Disaster Science and any member or members of its personnel to collect, use, hold and process its User Data and any Personal Information in accordance with the Privacy Act, any other applicable Privacy Laws of any jurisdiction including Disaster Science’s Privacy Policy as amended from time to time, and this Agreement. The User warrants that it has capacity to provide the consent under this clause.

22. (Deletion of Data): The User acknowledges that Disaster Science may at any time without cause or notice, permanently delete any data, with no obligation as to back-ups or liability for loss of User Data in any form.
...
28. (Rights to Restrict): Without limiting any other right or remedy available to Disaster Science, Disaster Science may restrict or suspend the User’s access to the Service and/or delete, edit or remove the relevant User Data if Disaster Science considers that the User has:
    ...
    2. used, or attempted to use, the Service:
       ...
       2. used, or attempted to use, the Service: (a) for improper purposes; or (b) in a manner, other than for normal operational purposes, that materially reduces the operational performance of the Service;
...
30. (No implied warranties): To the maximum extent permitted by law, Disaster Science’s warranties are limited to those expressly stated in this Agreement and Disaster Science otherwise makes no representation concerning the quality of the Services and does not promise that the Services will:
    1. meet the User’s requirements or be suitable for a particular purpose, including that the use of the Service will fulfil or meet any statutory role or responsibility of Disaster Science; or
...
32. (Indemnification by User):
    ...
    2. The User’s liability under clause 32.1 will be reduced proportionately to the extent that an act or omission of Disaster Science, its officers, employees, contractors and agents contributed to the liability, loss, claim, cost, penalty or demand (including any legal costs and expenses) incurred or suffered by Disaster Science.

33. (User Indemnification for collection, disclosure and storage): In addition to the indemnity outlined in clause 32, and for the avoidance of any doubt, the User must indemnify Disaster Science against all loss (including legal costs and expenses) incurred as a result of Disaster Science’s collection, use, disclosure, storage or other involvement with the User Data and any other information (in any form) relevant to the User’s relationship with Disaster Science under this Agreement.

34. (No indirect loss): To the extent that Disaster Science is liable for breach of contract in connection with the supply of the Services, Disaster Science excludes liability for loss of profit, revenue, business, savings, data (including User Data) or product, increased cost of production, loss of customer goodwill, or other special punitive, indirect or consequential loss or damage of any kind.
...
41. (Amendment): From time to time it may be necessary for Disaster Science to review and amend these Terms and Conditions. Disaster Science reserves the right to amend this Agreement at any time. The User should check the Platform from time to time for Disaster Science’s latest Terms and Conditions. The User’s continued use of the Services constitutes the User’s agreement to these Terms and Conditions and any future revisions.

42. (Governing law and Jurisdiction): This Agreement is governed by the laws in force in the Australian Capital Territory and the parties submit to the exclusive jurisdiction of the Supreme Court of the Australian Capital Territory to decide any dispute between them in relation to this Agreement.
